...
export class ChangePasswordModalComponent extends AppComponentBase {
    ...
    @ViewChild('currentPasswordInput', { read: ElementRef,static: false}) currentPasswordInput: ElementRef;
    @ViewChild('changePasswordModal', { read: ModalDirective,static: false}) modal: ModalDirective;
