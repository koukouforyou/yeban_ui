...
export class MySettingsModalComponent extends AppComponentBase {
    ...
    @ViewChild('mySettingsModal', { read: ModalDirective, static: false}) modal: ModalDirective;
    @ViewChild('smsVerificationModal', { read: SmsVerificationModalComponent,static: false}) smsVerificationModal: SmsVerificationModalComponent;
