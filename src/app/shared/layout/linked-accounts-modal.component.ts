...
export class LinkedAccountsModalComponent extends AppComponentBase {
    ...
    @ViewChild('linkedAccountsModal', { read: ModalDirective,static: false}) modal: ModalDirective;
    @ViewChild('linkAccountModal', { read: LinkAccountModalComponent,static: false}) linkAccountModal: LinkAccountModalComponent;
