...
export class DemoUiDateTimeComponent extends AppComponentBase {
    ...
    @ViewChild('SampleDatePicker', { read: ElementRef, static: false}) sampleDatePicker: ElementRef;
    @ViewChild('SampleDateTimePicker', { read: ElementRef,static: false}) sampleDateTimePicker: ElementRef;
