...
export class UsersComponent extends AppComponentBase {
    ...
    @ViewChild('createOrEditUserModal', { read:CreateOrEditUserModalComponent,static: false}) createOrEditUserModal: CreateOrEditUserModalComponent;
    @ViewChild('editUserPermissionsModal', { read:EditUserPermissionsModalComponent,static: false}) editUserPermissionsModal: EditUserPermissionsModalComponent;
