...
export class HostDashboardComponent extends AppComponentBase implements OnInit {
    @ViewChild('EditionStatisticsChart', { read: ElementRef, static: false}) editionStatisticsChart: ElementRef;
    @ViewChild('IncomeStatisticsChart', { read: ElementRef,static: false}) incomeStatisticsChart: ElementRef;

    @ViewChild('RecentTenantsTable', { read: Table,static: false}) recentTenantsTable: Table;
    @ViewChild('ExpiringTenantsTable', { read: Table,static: false}) expiringTenantsTable: Table;
