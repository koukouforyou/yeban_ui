...
export class TenantFeaturesModalComponent extends AppComponentBase {
    ...
    @ViewChild('tenantFeaturesModal', { read: ModalDirective, static: false}) modal: ModalDirective;
    @ViewChild('featureTree', { read: FeatureTreeComponent, static: false}) featureTree: FeatureTreeComponent;
