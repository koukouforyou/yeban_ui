...
import { TenantLinkModelComponent } from './tenant-link-model/tenant-link-model.component';
...
export class TenantsComponent extends AppComponentBase implements OnInit {
    ...
    @ViewChild('impersonateUserLookupModal', { read: CommonLookupModalComponent,static: true}) impersonateUserLookupModal: CommonLookupModalComponent;
    @ViewChild('createTenantModal', { read: CreateTenantModalComponent, static: false}) createTenantModal: CreateTenantModalComponent;
    @ViewChild('editTenantModal', { read: EditTenantModalComponent, static: false}) editTenantModal: EditTenantModalComponent;
    @ViewChild('tenantFeaturesModal', { read: TenantFeaturesModalComponent, static: false}) tenantFeaturesModal: TenantFeaturesModalComponent;
    ...
    @ViewChild('tenantsLinkModal',{read:TenantLinkModelComponent,static:false}) tenantsLinkModal:TenantLinkModelComponent;
    ...
    showTenantsLink(id:number):void{
        this.tenantsLinkModal.show(id);
    }
