...
export class CreateOrEditLanguageModalComponent extends AppComponentBase {
    ...
    @ViewChild('languageCombobox', { read: ElementRef,static: false}) languageCombobox: ElementRef;
    @ViewChild('iconCombobox', { read: ElementRef,static: false}) iconCombobox: ElementRef;
