...
export class EditTextModalComponent extends AppComponentBase {
    ...
    @ViewChild('targetValueInput', { read: ElementRef,static: false}) targetValueInput: ElementRef;
    @ViewChild('modal', { read: ModalDirective,static: false}) modal: ModalDirective;
