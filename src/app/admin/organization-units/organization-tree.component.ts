...
export class OrganizationTreeComponent extends AppComponentBase implements OnInit {
    ...
    @ViewChild('createOrEditOrganizationUnitModal', { read: CreateOrEditUnitModalComponent, static: false}) createOrEditOrganizationUnitModal: CreateOrEditUnitModalComponent;
